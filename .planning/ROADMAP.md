...
- [ ] 01-01-repo-scaffold-docker-verify-PLAN.md — **Wave 1.** Monorepo scaffold, .env.example, Makefile + PowerShell fallback, README "About the Name" (mentions admin_unit role per CONTEXT.md Auth), Docker-installed verify checkpoint.
